...
- Medium
- [Submission](https://leetcode.com/problems/minimum-length-of-string-after-operations/submissions/1507300535/)
...
- It's just a pattern where, if the count of any particular character is event, it will always end up with 2, and if it is odd, it will always end up with 1.
- With this, find the frequency of each character, and determine the final count.
