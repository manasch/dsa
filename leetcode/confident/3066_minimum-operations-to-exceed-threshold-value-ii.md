...
- Medium
- [Submission](https://leetcode.com/problems/minimum-operations-to-exceed-threshold-value-ii/submissions/1541406777/)
...
- priority queue the values, long long the count
- top two values of the queue will be the required values. perform operation and insert.
