...
- Medium
- [Submission](https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color/submissions/1064770822/)
...
- This is not dp as in 'aba' b will never be removed, so no need to check for merger of chars after removal.
- Count how many each can remove, whoever greater wins. If equal, bob wins.
