...
- Medium
- [Submission](https://leetcode.com/problems/maximal-score-after-applying-k-operations/submissions/1422294045/)
...
- This is pretty straightforward, it is always optimal to pick the biggest value, and this can be achieved by using a max-heap.
