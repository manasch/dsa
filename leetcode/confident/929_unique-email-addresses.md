...
- Easy
- [Submission](https://leetcode.com/problems/unique-email-addresses/submissions/1005142567/)
...
public:
    int numUniqueEmails(vector<string>& emails) {
        ...
        for (auto email: emails) {
            ...
            e += "@";
            e.insert(e.end(), email.begin() + idx + 1, email.end());
            h.insert(e);
        }
        return h.size();
    }
...
- String splitting and joining, surely a better method exists.
