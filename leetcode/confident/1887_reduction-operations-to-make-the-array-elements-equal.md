...
- Medium
- [Submission](https://leetcode.com/problems/reduction-operations-to-make-the-array-elements-equal/submissions/1101825027/)
- array, sorting
...
- This just requires you to convert the greatest one to the next greatest one, then all of those to the next greatest one and so on.
- The indexing doesn't really matter.
- Hence, just keep track of a count, sort the array, the first time they differ, add the count to the res.
