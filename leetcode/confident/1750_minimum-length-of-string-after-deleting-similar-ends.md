...
- Medium
- [Submission](https://leetcode.com/problems/minimum-length-of-string-after-deleting-similar-ends/submissions/1194599456/)
- two-pointers, string
- Contest: none
...
- Two pointer solution, decreasing the array being considered by checking the characters on the left and right.
- Move the left pointer to the right while the next character matches the character pointed to the right and vice versa.
- Break the loop when the characters pointed by the pointers are do not match.
