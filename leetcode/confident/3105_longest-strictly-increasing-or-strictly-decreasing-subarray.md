...
- Easy
- [Submission](https://leetcode.com/problems/longest-strictly-increasing-or-strictly-decreasing-subarray/submissions/1529459904/)
- array
- Contest: none
...
- keep 2 counts, one for increasing and one for decreasing, update max at each index.
- can be done with just one count too, but not required, can be used for fun.
