...
- Easy
- [Submission](https://leetcode.com/problems/number-of-1-bits/submissions/1042811103/)
...
- Having a bitmask and anding it with the original number for each position, if that result is equal to the bitmask, that means the bit is set and therefore increment the counter.
