...
- Medium
- [Submission](https://leetcode.com/problems/product-of-the-last-k-numbers/submissions/1542970775/)
...
- prefix product, but the only issue was the handle the 0 edge case.
- when 0 is inserted, can invalidate the prefix product array till now and start from scratch again, if the k asked is greater than the product array size, just return 0, other wise return the quotient of the total product by the product k indices back.
